...
class OpenAIParser:
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            "wechat.open => params {}, "
            "wechat.read_last_message => params {mode: \"all\"|\"last\"|\"summary\"|\"reply_advice\"} with optional contact: string and optional instruction: string, "
            ...
            "Use mode \"reply_advice\" when the user wants help replying, continuing the chat, or deciding what to say next. "
